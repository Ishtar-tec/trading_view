    ...
    ["general-property-page"], {
            ...
            function s(e, t) {
                ...
                function l() {
                    if (!i) {
                        i = Object(a.a)();
                        var r = n.getValue(e);
                        void 0 === r && void 0 !== t && (r = n.getValue(t)), i.setValue(o(r)), i.subscribe(i, (function (t) {
                    ...
                    actualBehavior: function () {
                        if (!s) {
                            ...
                            var e = l(),
                                t = function () {
                                    var t = e.value();
                                    t !== r.AlwaysOn && t !== r.AlwaysOff && (t = Modernizr.mobiletouch ? r.AlwaysOn : r.VisibleOnMouseOver), s && s.setValue(t)
                                };
                            e.subscribe(s, t), t()
                        }
                        return s
        ...
        "5lPo": function (e, t, i) {
            ...
            function S(e, t, i, r, a) {
                ...
                var b = function (e, t) {
                    return null !== t && n.enabled("buy_sell_buttons") ? Object(l.c)({
            ...
            var _ = i("oXaB"),
                ...
                B = (window.t("Symbol Previous Day Close Price Label (Intraday Only)"), window.t("Indicator Name Label")),
                x = window.t("Indicator Last Value Label"),
                A = (window.t("Financials Name Label"), window.t("Financials Last Value Label"), window.t("Bid and Ask Labels"), window.t("Pre/Post Market Price Label"), window.t("High and low price labels")),
            ...
            var re, ae = i("e1ZQ"),
                ...
                de = i("iUxq"),
                pe = i("WS5G"),
                be = ((re = {}).symbol = le, re.legend = ce, re.scales = ue, re.appearance = he, re.events = de, re.trading = pe, re);
            ...
            var Pe = [{
                ...
                me = function () {
                    function e(e, t, i) {
                        this._propertyPages = null, this._maxRightOffsetPropertyObject = null, this._isDestroyed = !1, this._undoModel = e, this._model = this._undoModel.model(), this._series = this._model.mainSeries(), this._chartWidgetProperties = t, this._options = i, this._seriesPropertyDefinitionViewModel = this._createSeriesViewModel(),
                    ...
                    return e.prototype.destroy = function () {
                        ...
                        return null === this._propertyPages ? this._seriesPropertyDefinitionViewModel.propertyPages().then((function (t) {
                            ...
                            return null === e._propertyPages && (e._propertyPages = Object(r.f)(t), e._propertyPages.push(e._legendPropertyPage, e._scalesPropertyPage, e._appearancePropertyPage), null !== e._tradingPropertyPage && e._propertyPages.push(e._tradingPropertyPage), null !== e._eventsPropertyPage && e._propertyPages.push(e._eventsPropertyPage)), e._propertyPages
                        ...
                        return new p.a(this._series, this._undoModel, "symbol", ge, be.symbol, e)
                        ...
                        var e = this._chartWidgetProperties.childs().paneProperties.childs().legendProperties.childs(),
                            ...
                            i = S(this._undoModel, e, t, this._options.marketStatusWidgetEnabled ? b.b : null, Oe);
                        ...
                        var e, t = this._chartWidgetProperties.childs().scalesProperties.childs(),
                            i = {
                            ...
                            r = {
                                ...
                                values: (e = new Date(Date.UTC(1997, 8, 29)), ae.a.map((function (t) {
                                    return {
                                        value: t,
                        ...
                        return function (e, t, i, r) {
                            ...
                            var d = t.highLowAvgPrice,
                                p = Object(l.c)({
                                    checked: Object(l.b)(e, d.childs().highLowPriceLabelsVisible, "Change high/low price labels visibility")
                                }, {
                                    id: "highLowPriceLabels",
                                    title: A
                                }),
                                b = Object(l.c)({
                                    checked: Object(l.b)(e, d.childs().averageClosePriceLabelVisible, "Change average close price label visibility")
                                }, {
                                    id: "averageClosePriceLabels",
                                    title: z
                                });
                            c.push(p, b);
                            var g = Object(l.c)({
                            ...
                            if (e.crossHairSource().isMenuEnabled()) {
                                var P = Object(l.c)({
                                    checked: Object(l.b)(e, L.addPlusButtonProperty, "Plus Button")
                                }, {
                                    id: "addPlusButton",
                                    title: H
                                });
                            ...
                            var m = Object(l.i)({
                                    ...
                                    value: Object(l.x)(e, r.mainSeriesScaleRatioProperty, "Change Price to Bar Ratio", [Object(V.c)(7), function (e) {
                                        return e
                                    }])
                                }, {
                                    id: "lockScale",
                            ...
                            w = function (e, t, i, r, a, o, c, u, h) {
                                var d = [],
                                    p = Object(l.e)({
                                        ...
                                        gradientColor1: Object(l.u)(e, t.backgroundGradientStartColor, null, "Change Chart Background Color"),
                                    ...
                                    f = Object(l.h)({
                                        color: Object(l.u)(e, m.color, m.transparency, "Change Crosshair Color"),
                                        width: Object(l.b)(e, m.width, "Change Crosshair Width"),
                                        style: Object(l.b)(e, m.style, "Change Crosshair Style")
                                    }, {
                                        id: "crossHair",
                                        title: Y
                                    });
