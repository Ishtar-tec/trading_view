    ...
    ["general-chart-properties-dialog"], {
        ...
        An2S: function (e, t, n) {
            ...
            function d(e) {
                ...
                return i.a.createElement("div", Object(o.a)({}, a, {
                    className: d,
            ...
            function p(e) {
                return i.a.createElement("div", Object(o.a)({
                    className: m.wrapper
                }, e))
            }
            ...
            function h(e) {
                var t = e.mode,
                    ...
                    b = h.isMobile,
                    f = h.isTablet;
                return i.a.createElement("div", Object(o.a)({}, p, {
        ...
        Iivm: function (e, t, n) {
            ...
            const i = a.forwardRef((e, t) => {
                const {
                    icon: n = ""
                } = e, i = Object(o.e)(e, ["icon"]);
                return a.createElement("span", Object.assign({}, i, {
                    ref: t,
        ...
        PI1I: function (e, t, n) {
            ...
            function P(e) {
                var t = e.themeName,
                    ...
                    m = a.useCallback((function () {
                        return function (e, t, n) {
                            window.is_authenticated && Object(_.a)({
                                text: T.format({
                                    name: e
                                }),
                ...
                return a.createElement("div", Object(o.a)({}, c), a.createElement(y.b, {
            ...
            var B = n("HWhk"),
                ...
                M = (Object(S.appendEllipsis)(window.t("Save As")), window.t("Apply to all")),
                N = function (e) {
                    function t(t) {
                        var n = e.call(this, t) || this;
                        return n._manager = null, n._handleApplyDefaults = function () {
                            var e = n.props,
                                t = e.model,
                        ...
                        }, n._handleSaveAs = function () {}, n._handleRemoveTheme = function (e) {
                            n.setState({
                    ...
                    return Object(o.c)(t, e), t.prototype.render = function () {
                        ...
                        return a.createElement(C.b.Consumer, null, (function (t) {
                            return e._manager = t, a.createElement(b.a, {
                        ...
                        var t = this,
                            ...
                            r = e && i ? Object(o.f)([this._applyToAllDropdownItem, this._getPlaceHolderItem(e)], this._defaultDropdownItems) : Object(o.f)([this._getPlaceHolderItem(e)], this._defaultDropdownItems),
                            s = this.state.themes;
                        ...
                        return {
                            ...
                            readonly: !0,
                            content: "",
                            selectedContent: e ? a.createElement(r.a, {
                ...
                q = function (e) {
                    function t(t) {
                        ...
                        n._renderChildren = function (e) {
                            var t = e.requestResize,
                                o = e.isSmallWidth;
                            return n._requestResize = t, a.createElement("div", {
                                className: R.content
                            }, n._renderTabs(o), n._renderTabContent(o))
                            ...
                            e !== t && (t && t.definitions.unsubscribe(n._onChangeActivePageDefinitions), p.a.setValue("properties_dialog.last_page_id", e.id), e.definitions.subscribe(n._onChangeActivePageDefinitions), n.setState({
                                activePage: e,
                                tableKey: Date.now()
                            }, (function () {
                            ...
                            j.a.logNormal("Definition collection was updated"), n.setState({
                                tableKey: Date.now()
                            }, (function () {
                                n._requestResize && n._requestResize()
                            }))
                            ...
                            n.setState({
                                isApplyToAllVisible: Object(h.isMultipleLayout)(e.layout.value())
                            })
                        }, n._handleBackClick = function () {
                            var e = n.state.activePage;
                            e && e.definitions.unsubscribe(n._onChangeActivePageDefinitions), n.setState({
                                activePage: null
                            })
                        };
                        var o = t.pages,
                    ...
                    return Object(o.c)(t, e), t.prototype.componentDidMount = function () {
                        ...
                        e.layout.subscribe(this._syncApplyToAllVisibility), t && t.definitions.subscribe(this._onChangeActivePageDefinitions)
                    }, t.prototype.componentWillUnmount = function () {
                        var e = this.props.chartWidgetCollection,
                            t = this.state.activePage;
                        t && t.definitions.unsubscribe(this._onChangeActivePageDefinitions), e.layout.unsubscribe(this._syncApplyToAllVisibility)
                        ...
                        return a.createElement(b.a, {
                            ...
                            return a.createElement(c.a, {
                                ...
                                additionalHeaderElement: null !== i && t ? a.createElement(r.a, {
                        ...
                        if (n) {
                            ...
                            return a.createElement(D.a, {
                                className: R.tabContent,
                                onScroll: this._handleScroll
                            }, a.createElement(m.b.Provider, {
                                value: W
                            }, a.createElement(u.a, {
                        ...
                        return !e && t && a.createElement("span", {
                ...
                G = function (e) {
                    function t(t) {
                        ...
                        return n._handleClose = function () {
                            i.unmountComponentAtNode(n._container), n._setVisibility(!1), n._onClose && n._onClose()
                        }, n._handleSubmit = function () {}, n._handleCancel = function () {
                            n._model.undoToCheckpoint(n._checkpoint)
                        }, n._propertyPages = t.propertyPages, n._model = t.model, n._activePageId = t.activePageId, n._onClose = t.onClose, n._chartWidgetCollection = t.chartWidgetCollection, n._checkpoint = n._ensureCheckpoint(t.undoCheckPoint), n
                    }
                    return Object(o.c)(t, e), t.prototype.hide = function (e) {
                        e ? this._handleCancel() : this._handleSubmit(), this._handleClose()
                    }, t.prototype.isVisible = function () {
                        return this.visible().value()
                    }, t.prototype.focusOnText = function () {}, t.prototype.show = function () {
                        i.render(a.createElement(q, {
                            title: Q,
                            isOpened: !0,
                        ...
                        }), this._container), this._setVisibility(!0), K.emit("edit_object_dialog", {
